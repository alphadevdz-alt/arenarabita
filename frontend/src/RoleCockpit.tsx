...
export function menusFor(role: string): { id: string; label: string }[] {
  ...
  if (role === 'SYSTEM_ADMINISTRATOR') return [{ id: 'home', label: 'لوحة المشرف' }, verify, { id: 'cards', label: 'بطاقات الانخراط' }, { id: 'users', label: 'المستخدمون' }, { id: 'organizations', label: 'الرابطات' }, { id: 'audit', label: 'التدقيق' }, { id: 'reports', label: 'التقارير' }, account];
  if (role === 'NATIONAL_ADMINISTRATOR') return [{ id: 'home', label: 'لوحة وطنية' }, verify, { id: 'cards', label: 'بطاقات الانخراط' }, { id: 'seasons', label: 'المواسم' }, { id: 'competitions', label: 'المنافسات' }, { id: 'announcements', label: 'الإعلانات' }, { id: 'results', label: 'النتائج' }, { id: 'reports', label: 'التقارير' }, account];
  if (role === 'ASSOCIATION_ADMINISTRATOR') return [{ id: 'home', label: 'لوحة الرابطة' }, verify, { id: 'approvals', label: 'طلبات الانخراط' }, { id: 'cards', label: 'بطاقات الانخراط' }, { id: 'institutions', label: 'المؤسسات' }, { id: 'participants', label: 'المشاركون' }, { id: 'licenses', label: 'التراخيص' }, { id: 'entries', label: 'التسجيلات' }, account];
  ...
  return [{ id: 'home', label: 'لوحة المؤسسة' }, verify, { id: 'participants', label: 'تلاميذ المؤسسة' }, { id: 'cards', label: 'بطاقات الانخراط' }, { id: 'licenses', label: 'طلب ترخيص' }, { id: 'entries', label: 'التسجيل في منافسة' }, account];
}
